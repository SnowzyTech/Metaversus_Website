...
const Feedback = () => (
  ...
  >
    ...
    >
      ...
      <p className="mt-[25px] font-normal sm:text-[24px] text-[18px] sm:leading-[45px] leading-[40px] text-white">
        "With the development of today's technology 
        metaverse is very useful
    ...
    <motion.div
      ...
      className="flex justify-center relative flex-1 items-center"
    >
      <img 
        src="/planet-09.png"
        alt="planet-09"
      ...
      <motion.div
       ...
       className="lg:block hidden absolute -left-[10%] top-[4%]"
      >
        <img 
          src="/stamp.png" 
          alt="stamp" 
